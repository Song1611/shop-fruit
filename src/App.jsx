...
const App = () => {
  ...
  const addToCart = (product, quantity = 1, size = '1KG') => {
    const pPrice = product.currentPrice || '0,00';
    const existingItemIndex = cartItems.findIndex(item => item.name === product.name && item.size === size);
    if (existingItemIndex > -1) {
      const newCart = [...cartItems];
      newCart[existingItemIndex].quantity += quantity;
      setCartItems(newCart);
    } else {
      setCartItems([...cartItems, { ...product, currentPrice: pPrice, quantity, size, cartId: Date.now() + Math.random() }]);
    }
  ...
  const navigateToCategory = (e, catName) => {
    e.preventDefault();
  ...
  const news = [
    { title: 'Cải thiện sức khỏe và làn da từ thực phẩm hữu cơ', date: '13 Th05, 2023', comments: 0, img: 'https://cdn.pixabay.com/photo/2017/09/16/19/21/salad-2756467_960_720.jpg', excerpt: 'Lorem ipsum dolor sit amet, consectetuer adipiscing elit doli. Aenean commodo ligula eget dolor. ...' },
    { title: 'Luôn luôn tươi mới, luôn luôn khỏe mạnh', date: '13 Th05, 2023', comments: 1, img: 'https://cdn.pixabay.com/photo/2016/09/21/20/45/bell-peppers-1685731_960_720.jpg', excerpt: 'Lorem ipsum dolor sit amet, consectetuer adipiscing elit doli. Aenean commodo ligula eget dolor. ...' },
    { title: 'Hỗn hợp chay đặc biệt với công thức bí truyền', date: '13 Th05, 2023', comments: 0, img: 'https://cdn.pixabay.com/photo/2017/05/23/22/33/almonds-2338833_960_720.jpg', excerpt: 'Lorem ipsum dolor sit amet, consectetuer adipiscing elit doli. Aenean commodo ligula eget dolor. ...' }
  ];
  ...
  return (
    <>
      ...
      <div className="header-wrapper">
        ...
        <div className="container header-content">
          ...
          <div className="header-icons">
            ...
            <div className="icon-item" style={{ cursor: 'pointer' }} onClick={() => setCurrentPage('wishlist')}>
              <Heart size={26} strokeWidth={1.5} />
              <span className="badge">{wishlistItems.length}</span>
            </div>
            <div className="icon-item" onClick={() => setIsCartOpen(true)}>
              <ShoppingBag size={26} strokeWidth={1.5} />
              <span className="badge">{cartItems.reduce((sum, item) => sum + item.quantity, 0)}</span>
            </div>
          </div>
        </div>
      </header>
        ...
        <div className="container nav-content">
          <div className="browse-cat-wrap">
            ...
            <div className="cat-dropdown">
              <ul>
                <li>
                  <a href="#" onClick={(e) => navigateToCategory(e, 'Trái cây tươi')}>
                    <img src="https://cdn-icons-png.flaticon.com/128/3137/3137002.png" alt="icon" />
                    Trái cây tươi <ChevronRight className="icon-right" size={16} />
                  </a>
                  <div className="side-mega-menu">
                    <div className="mega-col">
                      <h4>Thực phẩm cơ bản</h4>
                      <ul>
                        <li><a href="#" onClick={(e) => navigateToCategory(e, 'Trái cây tươi')}>Mâm xôi 100% hữu cơ</a></li>
                        <li><a href="#" onClick={(e) => navigateToCategory(e, 'Trái cây tươi')}>Thực phẩm sạch khỏe</a></li>
                        <li><a href="#" onClick={(e) => navigateToCategory(e, 'Trái cây tươi')}>Nước cam tự nhiên</a></li>
                        <li><a href="#" onClick={(e) => navigateToCategory(e, 'Trái cây tươi')}>Vải tươi hữu cơ</a></li>
                        <li><a href="#" onClick={(e) => navigateToCategory(e, 'Trái cây tươi')}>Cà rốt tự nhiên</a></li>
                      </ul>
                    </div>
                    <div className="mega-col">
                      <h4>Thảo mộc & Gia vị</h4>
                      <ul>
                        <li><a href="#" onClick={(e) => navigateToCategory(e, 'Trái cây tươi')}>Trái cây nhiệt đới</a></li>
                        <li><a href="#" onClick={(e) => navigateToCategory(e, 'Trái cây tươi')}>Mâm xôi 100% hữu cơ</a></li>
                        <li><a href="#" onClick={(e) => navigateToCategory(e, 'Trái cây tươi')}>Vải tươi hữu cơ</a></li>
                        <li><a href="#" onClick={(e) => navigateToCategory(e, 'Trái cây tươi')}>Chuối tươi an toàn</a></li>
                        <li><a href="#" onClick={(e) => navigateToCategory(e, 'Trái cây tươi')}>Dưa hấu nguyên trái</a></li>
                      </ul>
                    </div>
                    <div className="mega-col">
                      <h4>Thực phẩm tươi khỏe</h4>
                      <ul>
                        <li><a href="#" onClick={(e) => navigateToCategory(e, 'Trái cây tươi')}>Cam xanh tươi</a></li>
                        <li><a href="#" onClick={(e) => navigateToCategory(e, 'Trái cây tươi')}>Lá chuối tươi</a></li>
                        <li><a href="#" onClick={(e) => navigateToCategory(e, 'Trái cây tươi')}>Bột các loại</a></li>
                        <li><a href="#" onClick={(e) => navigateToCategory(e, 'Trái cây tươi')}>Đậu & Hạt</a></li>
                      </ul>
                    </div>
                    <div className="mega-col">
                      ...
                      <ul>
                        <li><a href="#" onClick={(e) => navigateToCategory(e, 'Trái cây tươi')}>Nước cam tự nhiên</a></li>
                        <li><a href="#" onClick={(e) => navigateToCategory(e, 'Trái cây tươi')}>Sinh tố bơ</a></li>
                        <li><a href="#" onClick={(e) => navigateToCategory(e, 'Trái cây tươi')}>Đu đủ 100% hữu cơ</a></li>
                        <li><a href="#" onClick={(e) => navigateToCategory(e, 'Trái cây tươi')}>Nước ép táo</a></li>
                      </ul>
                    </div>
                  </div>
                </li>
                <li><a href="#" onClick={(e) => navigateToCategory(e, 'Rau củ tươi')}><img src="https://cdn-icons-png.flaticon.com/128/6809/6809462.png" alt="icon" /> Rau củ tươi</a></li>
                <li><a href="#" onClick={(e) => navigateToCategory(e, 'Trái cây khô hữu cơ')}><img src="https://cdn-icons-png.flaticon.com/128/4155/4155160.png" alt="icon" /> Trái cây khô hữu cơ</a></li>
                <li><a href="#" onClick={(e) => navigateToCategory(e, 'Gia vị hữu cơ')}><img src="https://cdn-icons-png.flaticon.com/128/3137/3137002.png" alt="icon" /> Gia vị hữu cơ</a></li>
                <li><a href="#" onClick={(e) => navigateToCategory(e, 'Nước ép hữu cơ')}><img src="https://cdn-icons-png.flaticon.com/128/2459/2459288.png" alt="icon" /> Nước ép hữu cơ</a></li>
                <li><a href="#" onClick={(e) => navigateToCategory(e, 'Trái cây mùa hè')}><img src="https://cdn-icons-png.flaticon.com/128/3137/3137002.png" alt="icon" /> Trái cây mùa hè</a></li>
                <li><a href="#" onClick={(e) => navigateToCategory(e, 'Bánh mỳ & Ngũ cốc')}><img src="https://cdn-icons-png.flaticon.com/128/4155/4155160.png" alt="icon" /> Bánh mỳ & Ngũ cốc</a></li>
                <li><a href="#" onClick={(e) => navigateToCategory(e, 'Bơ & Sữa')}><img src="https://cdn-icons-png.flaticon.com/128/6809/6809462.png" alt="icon" /> Bơ & Sữa</a></li>
                <li><a href="#" onClick={(e) => navigateToCategory(e, 'Rượu vang hữu cơ')}><img src="https://cdn-icons-png.flaticon.com/128/2459/2459288.png" alt="icon" /> Rượu vang hữu cơ</a></li>
              </ul>
            </div>
          </div>
          <ul className="nav-links">
            <li><a href="#" onClick={(e) => { e.preventDefault(); setCurrentPage('home'); }} style={{ display: 'flex', alignItems: 'center', gap: '4px' }}>Trang chủ</a></li>
            <li><a href="#" style={{ display: 'flex', alignItems: 'center', gap: '4px' }}>Bộ sưu tập <ChevronDown size={14} /></a></li>
            <li><a href="#" onClick={(e) => { e.preventDefault(); setCurrentPage('news'); }}>Tin tức</a></li>
          ...
          <div className="header-icons" style={{ paddingRight: '15px' }}>
            <Headphones size={28} />
            <div className="icon-text">
              <span style={{ color: 'var(--primary-green)' }}>Hotline:</span>
              <p style={{ color: 'white' }}>0123 456 789</p>
            </div>
          </div>
        </div>
        </nav>
      ...
      {currentPage === 'home' ? (
          ...
          <div className="container main-layout">
            ...
            <main className="main-content">
                ...
                {products.slice(0, 3).map((p, idx) => (
                  <div className="product-card" key={idx}>
                    <div className="product-image-container">
                      ...
                      <img src={p.img} alt={p.name} style={{ cursor: 'pointer' }} onClick={(e) => navigateToProduct(e, p)} />

                      <div className="product-actions">
                        <button className="action-btn" onClick={() => addToWishlist(p)}><Heart size={18} /></button>
                        <button className="action-btn" onClick={(e) => openQuickView(e, p)}><ShoppingBag size={18} /></button>
                        <button className="action-btn" onClick={(e) => openQuickView(e, p)}><Eye size={18} /></button>
                        <button className="action-btn"><BarChart2 size={18} /></button>
                      </div>
                    </div>
                    <div className="product-info">
                      <a href="#" className="product-title" onClick={(e) => navigateToProduct(e, p)}>{p.name}</a>
              ...
              <div className="deal-row">
                <div className="deal-main">
                  ...
                  <div className="deal-info">
                    ...
                    <h5 className="product-title" style={{ marginTop: '20px', cursor: 'pointer' }} onClick={(e) => navigateToProduct(e, { name: 'Việt quất tươi', currentPrice: '35,00', oldPrice: '51,00', img: 'https://cdn.pixabay.com/photo/2015/09/24/19/33/berries-956020_960_720.jpg', stars: 5, reviews: 2 })}>Việt quất tươi</h5>
                    <div className="price-container">
              ...
              <div style={{ textAlign: 'center', marginBottom: '20px' }}>
                <button className="btn-primary" onClick={() => setCurrentPage('news')}>Xem tất cả tin tức</button>
              </div>
        ...
        <CategoryPage initialCategory={selectedCategory} navigateToProduct={navigateToProduct} openQuickView={openQuickView} addToCart={addToCart} addToWishlist={addToWishlist} />
      ) : currentPage === 'product-detail' ? (
        <ProductDetailPage product={selectedProduct} navigateToCategory={navigateToCategory} addToCart={addToCart} addToWishlist={addToWishlist} />
